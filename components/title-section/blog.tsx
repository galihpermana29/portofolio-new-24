	...
	if (!isMatchedTarget) {
		return (
			<div
				...
				<div className="libre text-[70px] italic absolute bottom-[-20px] left-0 right-0 text-center text-[#201f1e]">
					Medium
				</div>
			</div>
		);
		...
		<div
			...
			<div className=" h-screen flex justify-center items-center">
				<div className="mb-[100px]">
					<div className="libre italic text-[30px] mb-[30px] text-[#fcfaf5]">
						Read My Thoughts
					</div>
					<div
						className="text-[55px] max-w-[800px] text-[#fcfaf5]"
						ref={refSection}>
			...
			<div className="libre text-[250px] italic absolute bottom-[-100px] left-0 right-0 text-center text-[#201f1e]">
				Medium
			</div>
		</div>
	);
